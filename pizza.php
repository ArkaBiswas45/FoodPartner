...
$query = "SELECT restaurant_name, restu_logo,page_name FROM search_mappings WHERE menu_items LIKE '%pizza%'";
...
<header>
    ...
    <div class="result">
        ...
        if (mysqli_num_rows($result) > 0) {
            echo "<h1>Restaurants Offering Pizzas</h1>";
            echo "<ul>";
            ...
            echo "<p>No restaurants found with pizzas on the menu.</p>";
        }
        ?>
    </div>
    </main>
